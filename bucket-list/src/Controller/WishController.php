...
class WishController extends AbstractController
{
    ...
    public function addWish(EntityManagerInterface $entityManager, Request $request, Censurator $censurator): Response
    {
        $newWish = new Wish();
        ...
        if ($newWishForm->isSubmitted() && $newWishForm->isValid()) {
            $newWish->setDescription($censurator->purify($newWish->getDescription()));
